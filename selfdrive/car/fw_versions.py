...
GM_VERSION_REQUEST = bytes([uds.SERVICE_TYPE.GM_READ_DATA_BY_IDENTIFIER]) + \
  p16(uds.DATA_IDENTIFIER_TYPE.GM_BOOT_SOFTWARE_PART_NUMBER)
GM_VERSION_RESPONSE = bytes([uds.SERVICE_TYPE.GM_READ_DATA_BY_IDENTIFIER + 0x40]) + \
  p16(uds.DATA_IDENTIFIER_TYPE.GM_BOOT_SOFTWARE_PART_NUMBER)
