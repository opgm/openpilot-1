...
class Footnote(Enum):
  ...
  CAM_HARNESS = CarFootnote(
    ...
    Column.MODEL)
  # Not supported
  PEDAL_EV = CarFootnote(
    "ACC requires a [Pedal Interceptor](https://github.com/commaai/openpilot/wiki/comma-pedal)", Column.LONGITUDINAL)
  PEDAL_GAS = CarFootnote(
    "ACC requires a [Pedal Interceptor](https://github.com/commaai/openpilot/wiki/comma-pedal)", Column.LONGITUDINAL)
...
# Add any vehicles that require the non-standard DBC
CUSTOM_DBC: Dict[str,Dict[str,str]] = {
  ## Example
  #CAR.SILVERADO: dbc_dict('gm_global_b_powertrain_generated', 'gm_global_b_object', chassis_dbc='gm_global_b_chassis'),
  }

standard_dbc = dbc_dict('gm_global_a_powertrain_generated', 'gm_global_a_object', chassis_dbc='gm_global_a_chassis')

DBC: Dict[str,Dict[str,str]] = \
  {f: standard_dbc for f in dir(CAR) if not f.startswith("_") and f not in CUSTOM_DBC.keys()}
